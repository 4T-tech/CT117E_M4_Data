...
<img src="%5B7%5D图片/蓝桥杯嵌入式竞赛平台主视图.png" alt="蓝桥杯嵌入式竞赛平台主视图" width="60%">



## 文件结构

- [1]例程_四梯教研编：四梯教研编写的CT117E竞赛实训平台的例程

  - HAL库例程
  - LL库例程

- [2]例程_嵌入式设计与开发实训指导书：嵌入式设计与开发实训指导书配套例程
...
- [3]开发环境及辅助工具
  ...
  - Keil.STM32G4xx_DFP.1.2.0.pack、Keil.STM32G4xx_DFP.2.0.0.pack：STM32G4芯片包
  - PDF阅读器
  - ARMCC：AC5编译器
  - ReadMe.txt：CT117E竞赛实训平台硬件版本说明

- [4]硬件平台相关资料

  - 相关芯片手册：CT117E竞赛实训平台上相关芯片手册大全
  - CT117E_M4_UM：蓝桥杯嵌入式设计与开发竞赛实训平台用户手册
  - SCH_CT117E_M4_V1.1、SCH_CT117E_M4_V1.2：CT117E竞赛实训平台原理图

- [5]USB驱动：CT117E竞赛实训平台与PC连接时的USB端口驱动
...
- [6]测试文件
  ...
  - CT117E-M4_test.hex：CT117E竞赛实训平台测试程序
  - 测试流程说明_CT117E：测试流程说明
